...
# import ecoregions
# source: FAO (the layer from marine regions has topological problems)
...
#----------------------------------------------------
# We sumarize data per EEZ using average.
# Alternatively, we could merge EEZ polygon by country. Check this:
# combine polygons of same country that share borders
...
#write.csv(df, paste0(out_dir, "fao_change_df.csv"), row.names=FALSE)
